...
export default function OraculoKpiGrid({ kpis }: Props) {
  return (
    <section
      className="grid gap-3 px-4 py-4 sm:px-6 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-8"
      aria-label="Indicadores ORÁCULO"
    >
      {kpis.map((kpi) => (

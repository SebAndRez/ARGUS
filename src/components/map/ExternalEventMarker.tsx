...
export default function ExternalEventMarker({
  ...
  return (
    <div
      className={`flex h-11 w-11 items-center justify-center rounded-full border-2 font-mono text-[0.65rem] font-black shadow-[0_0_20px_rgba(249,115,22,0.35)] ${severityClasses[event.severity]} ${

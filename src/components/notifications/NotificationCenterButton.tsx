...
export default function NotificationCenterButton({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`pointer-events-auto fixed right-4 top-[5.35rem] z-[56] inline-flex min-h-11 items-center gap-2 border px-3 text-xs font-bold uppercase tracking-[0.12em] shadow-xl shadow-black/35 backdrop-blur-xl transition sm:right-5 sm:top-24 ${
        open

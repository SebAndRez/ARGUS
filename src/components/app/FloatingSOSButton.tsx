...
export default function FloatingSOSButton({ onClick, disabled }: FloatingSOSButtonProps) {
  return (
    <button
      ...
      disabled={disabled}
      className={`argus-mobile-sos fixed z-50 flex h-20 w-20 items-center justify-center rounded-full border text-white transition duration-200 focus:outline-none focus:ring-2 focus:ring-red-300/90 focus:ring-offset-2 focus:ring-offset-slate-950 ${
        disabled

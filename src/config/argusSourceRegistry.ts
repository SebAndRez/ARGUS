...
export const ARGUS_SOURCE_REGISTRY: ArgusSourceRegistryEntry[] = [
  ...
  { id: "gdacs", name: "GDACS", category: "disaster", tier: 1, priority: 92, status: "planned", reliabilityScore: 90, accessType: "free_with_terms", notes: "Alertas globales de desastre." },
